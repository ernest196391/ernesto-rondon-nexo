...
export const specialists: Specialist[] = [
  ...
  { id:"conversations",name:"NEXO Conversations",shortName:"Conversations",description:"Diseña y simula asistentes conversacionales con guardrails, lead scoring y handoff humano antes de conectar un canal real.",inputHint:"Negocio + reglas + mensaje",status:"ready",accent:"02" },
  ...
  { id:"content-studio",name:"NEXO Content Studio",shortName:"Content Studio",description:"Procesa vídeo en un worker separado y devuelve una versión vertical 1080×1920 lista para revisar y descargar.",inputHint:"Archivo de vídeo",status:"ready",accent:"05" },
