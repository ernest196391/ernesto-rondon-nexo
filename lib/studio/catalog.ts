...
export const specialists: Specialist[] = [
  ...
  { id: "business-audit", name: "NEXO Business Audit", shortName: "Business Audit", description: "Diagnóstico integral de negocio y roadmap técnico. Pendiente de incorporar el kit 03.", inputHint: "Negocio + contexto", status: "planned", accent: "03" },
];
