...
const items=[
 ...
 {href:"/admin/gestoras",label:"Gestoras"},
...
export default function AdminNav(){
 ...
 async function switchAccess(){if(busy)return;setBusy(true);try{await fetch("/api/gestoras/auth/logout",{method:"POST"});}finally{window.location.assign("/impulsa/login")}}
